...
public final class CoreMidiInputPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
  ...
  private static let methodChannelName = "com.liab.midi_music/core_midi_input/methods"
  private static let eventChannelName = "com.liab.midi_music/core_midi_input/events"
  ...
  private func createMidiClient() {
    let clientStatus = MIDIClientCreateWithBlock(
      "K478 CoreMIDI Input" as CFString,
      &midiClient
    ) { [weak self] _ in
    ...
    let portStatus = MIDIInputPortCreateWithBlock(
      midiClient,
      "K478 CoreMIDI Input Port" as CFString,
      &inputPort
