...
- `test/`：当前 Flutter 3.44.1 / Dart 3.12.1 基线共 261 项，包含声部分析、默认选择、MIDI→MusicXML、记谱服务、设置迁移、无损换谱和 App 回归；`integration_test/midi_notation_render_test.dart` 另做真实本地 OSMD 布局验收。
