...
for plugin in core_midi_input flutter_midi_pro; do
  ...
  write_valid_privacy_manifest "$privacy"
done
...
core_midi_privacy="$app_path/Frameworks/core_midi_input.framework/core_midi_input_privacy.bundle/PrivacyInfo.xcprivacy"
printf 'not a plist' > "$core_midi_privacy"
expect_rejected 'invalid privacy manifest'
write_valid_privacy_manifest "$core_midi_privacy"
